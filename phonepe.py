...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"D:\New folder (2)\download.jpeg"),width= 600)  

    col3,col4= st.columns(2)
    with col3:
        st.image(Image.open(r"D:\New folder (2)\download (2).jpeg"),width= 400)  
    ...
    with col4:
        ...
        st.write("****1. Direct Transaction & More****")
        st.write("****2. QR Code****")
    ...
    with col6:
            st.image(Image.open(r"D:\New folder (2)\download (1).jpeg"),width= 400)
    ...
    with tab1:
        ...
        if method == "Insurance Analysis":
            ...
            Aggre_trac_tac_Y_Q= Transaction_amount_count_Y_Q(Aggre_tran_tac_Y, quarters)   

            col1,col2= st.columns(2)
            with col1:
                states=st.selectbox("Select The States_Ty", Aggre_trac_tac_Y_Q["States"].unique())

            Aggre_Tran_Transaction_type(Aggre_trac_tac_Y_Q, states)
            ...
            with col1:
              ...
              years= st.slider("Select The User", Aggre_user["Years"].min(), Aggre_user["Years"].max(), Aggre_user["Years"].min())
